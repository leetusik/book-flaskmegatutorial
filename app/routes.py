...
def index():
    ...
    # # Check for validation errors when the form doesn't validate
    # if request.method == "POST" and not form.validate():
    #     # Debugging: print the errors to the console
    #     print(form.errors)

    #     # Optionally, flash the errors to the user
    #     for field, errors in form.errors.items():
    #         for error in errors:
    #             flash(_(f"Error in {field}: {error}", "danger"))
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(_("Your chagnes have been saved."))
